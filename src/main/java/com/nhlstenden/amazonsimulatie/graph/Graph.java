...
public class Graph <T extends Comparable<T>>
{
     ...
     */
    public void add(T from, T to, int cost, int x, int z)
    {
        ...
        else
        {
            ...
            Edge e = new Edge(from, to, cost, x, z);
            edges.add(e);
        }
    }
    ...
    private List<String> getShortestPath(Vertex target)
    {
        ...
        {
            path.add(v.value + " : cost : " + v.minDistance + " " + "X:" + v.x + " " + "Z:" + v.z);
        }
    ...
    class Vertex implements Comparable<Vertex>
    {
         ...
         * @param value T
         */
        public Vertex(T value, int x, int z)
        {
            this.value = value;
    ...
    class Edge
    {
         ...
         */
        public Edge(T v1, T v2, int cost, int x, int z)
        {
            from = findVertex(v1);
            if (from == null)
            {
